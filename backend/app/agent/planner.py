        ...
        "content": [
            {
                ...
                "text": (
                    ...
                    "  4. hook_scoring: score the top 3 hook candidates on:\n"
                    "       counterintuitive (0–10): contradicts widely held belief\n"
                    "       specific (0–10): names a number, name, or concrete claim\n"
                    "       curiosity_gap (0–10): opens a question viewer must stay to answer\n"
                    "     hook_score = sum (max 30). Minimum acceptable: 15.\n"
                    "     Select the highest-scoring moment ≤ 8s long as hook_moment.\n"
                    ...
                    "  score: 1–10  (10=max tension/conflict, 8=stat, 7=story,\n"
                    "                5=payoff, 3=connective, 1=filler)\n"
