        ...
        "content": [
            {
                ...
                "text": (
                    ...
                    "REORDERING REQUIREMENT — this is what separates great editors from bad ones:\n"
                    "After selecting segments, REORDER them for maximum psychological impact.\n"
                    "Do NOT keep source chronological order. Source order = amateur edit.\n\n"
                    "Step 1: Identify the most powerful/surprising moment → place it FIRST (position 0).\n"
                    "        Even if it's at minute 5 of a 6-minute transcript.\n"
                    "Step 2: Identify minimum context to understand that moment → place SECOND (position 1-2).\n"
                    "        Even if that context appears before the hook in source.\n"
                    ...
                    "MECHANIC 5 — HOOK FIRST (absolute law):\n"
                    "  Find the single most surprising/counterintuitive moment (score ≥ 15/30).\n"
                    "  Place it at position 0. Minimum context at position 1–2. Payoff last.\n"
                    "  Example from '3am / 10 miles' transcript:\n"
                    "    WRONG: [intro → context → running → haters → payoff]\n"
                    "    RIGHT: [10 miles hook → 3am detail → WHY → haters → payoff]\n\n"
                    ...
                    "MOTION GRAPHICS REQUIREMENT:\n"
                    "You MUST output at least 6 motion_graphics for any video under 60 seconds.\n"
                    "One motion graphic per keep_segment minimum.\n"
                    "Types to use:\n"
                    "  - key_phrase: for any powerful statement or quote\n"
                    "  - stat: for any number mentioned (10 miles, 3am, 6am, etc.)\n"
                    "  - checklist: for any list of items\n"
                    "  - title_card: ONLY for the opening hook (max 1 total)\n"
                    "Content must match EXACTLY what is being said at that timestamp.\n\n"
