...
_migrations = [
    ...
    "ALTER TABLE coaches ADD COLUMN plan TEXT DEFAULT 'free'",
    "ALTER TABLE coaches ADD COLUMN instagram_handle TEXT",
    "ALTER TABLE coaches ADD COLUMN tiktok_handle TEXT",
    "ALTER TABLE coaches ADD COLUMN twitter_handle TEXT",
    "ALTER TABLE coaches ADD COLUMN reddit_handle TEXT",
